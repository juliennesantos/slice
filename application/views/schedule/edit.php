<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('schedule/edit/'.$schedule['scheduleID']); ?>
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="timeStart" value="<?php echo ($this->input->post('timeStart') ? $this->input->post('timeStart') : $schedule['timeStart']); ?>" class="form-control" id="timeStart" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="timeEnd" class="control-label">TimeEnd</label>
						<div class="form-group">
							<input type="text" name="timeEnd" value="<?php echo ($this->input->post('timeEnd') ? $this->input->post('timeEnd') : $schedule['timeEnd']); ?>" class="form-control" id="timeEnd" />
						</div>
					</div>
				</div>
			</div>

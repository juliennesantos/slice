          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="programID" class="form-control">
								...
								{
									$selected = ($programcourse['refNo'] == $this->input->post('programID')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="studentNo" value="<?php echo $this->input->post('studentNo'); ?>" class="form-control" id="studentNo" min="8" max="8" />

...
<head>
  ...
  <!-- Custom CSS -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>resources/css/cssr.css">
...
<div id="container">
  <div id="one">
    <div class="col-lg-10 col-lg-offset-1">
      ...
      <script type="text/javascript" src="<?php echo base_url(); ?>resources/js/jssor.slider.min.js"></script>
      <script>
      ...
      <div id="slider1_container" style="position:relative;width:600px;height:300px;">
          ...
          <div u="slides" style="position: absolute; left: 0px; top: 0px; width: 750px; height: 500px;
              overflow: hidden;">
              <div>
                  <img u=image src="<?php echo base_url(); ?>resources/img/announcements/1.png"/>
              </div>
              <div>
                  <img u=image src="<?php echo base_url(); ?>resources/img/announcements/2.png"/>
              </div>
              <div>
                  <img u=image src="<?php echo base_url(); ?>resources/img/announcements/3.jpg"/>
              </div>
              <div>
                  <img u=image src="<?php echo base_url(); ?>resources/img/announcements/4.jpg"/>
              </div>
          </div>
      </div>
      <!-- End Carousel -->

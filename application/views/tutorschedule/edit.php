			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="timeblockID" class="form-control">
								...
								{
									$selected = ($timeblock['timeblockID'] == $tutorschedule['timeblockID']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="term" value="<?php echo ($this->input->post('term') ? $this->input->post('term') : $tutorschedule['term']); ?>" class="form-control" id="term" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="schoolYear" value="<?php echo ($this->input->post('schoolYear') ? $this->input->post('schoolYear') : $tutorschedule['schoolYear']); ?>" class="form-control" id="schoolYear" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="dateAdded" value="<?php echo ($this->input->post('dateAdded') ? $this->input->post('dateAdded') : $tutorschedule['dateAdded']); ?>" class="has-datetimepicker form-control" id="dateAdded" />

				...
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="time" name="timeStart" value="<?php echo ($this->input->post('timeStart') ? $this->input->post('timeStart') : $timeblock['timeStart']); ?>" class="form-control" id="timeStart" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="time" name="timeEnd" value="<?php echo ($this->input->post('timeEnd') ? $this->input->post('timeEnd') : $timeblock['timeEnd']); ?>" class="form-control" id="timeEnd" />

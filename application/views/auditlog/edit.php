    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Audit Edit Log</h3>
            </div>
			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="timeStamp" value="<?php echo ($this->input->post('timeStamp') ? $this->input->post('timeStamp') : $auditlog['timeStamp']); ?>" class="has-datetimepicker form-control" id="timeStamp" />
						</div>
					</div>
					<div class="col-md-6">

...
class adLDAP {
	...
	//var $_account_suffix="@csb.edu";
	//var $_base_dn = "DC=csb,DC=edu"; 
	var $_account_suffix="@benilde.edu.ph"; //effective 09 Jan 2015
	var $_base_dn = "DC=benilde,DC=edu,DC=ph"; //effective 09 Jan 2015	
	
	// An array of domain controllers. Specify multiple controllers if you 
	// would like the class to balance the LDAP queries amongst multiple servers
	//var $_domain_controllers = array ("csbtaft11.csb.edu");
	var $_domain_controllers = array ("csbtaft01.benilde.edu.ph"); //effective 09 Jan 2015	
	...
	function adLDAP($options=array()){
		...
		if ($this->_use_ssl){
			$this->_conn = ldap_connect("ldap://".$dc);
		} else {

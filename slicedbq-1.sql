...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 09, 2017 at 12:43 PM
...
CREATE TABLE `tutorialsessions` (
  ...
  `tutteeRemarks` varchar(200) DEFAULT NULL,
...
INSERT INTO `tutorialsessions` (`tutorialNo`, `tuteeID`, `tutorID`, `previousTutorID`, `subjectID`, `tutorScheduleID`, `dateTimeRequested`, `dateTimeStart`, `dateTimeEnd`, `tutteeRemarks`, `coordRemarks`, `dateAdded`, `dateModified`, `status`) VALUES
(1, 1, 1, 10, 1, 1, '2017-10-07 14:22:28', '2017-10-09 08:00:00', '2017-10-09 09:00:00', 'Give out more questions', NULL, '2017-10-07 00:00:00', '2017-10-07 00:00:00', 'Active'),
(2, 2, 2, 9, 2, 2, '2017-10-05 00:00:00', '2017-10-10 09:30:00', '2017-10-11 10:30:00', 'Remember to study NATSC11 curriculum', NULL, '2017-10-07 00:00:00', '2017-10-07 00:00:00', 'Active');
